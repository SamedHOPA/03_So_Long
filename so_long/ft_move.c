...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/21 15:21:20 by shopa             #+#    #+#             */
/*   Updated: 2022/04/25 15:19:16 by shopa            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_move(struct s_elements *g, int y, int x)
{
	...
	{
		ft_move(g, y, x);
		ft_printf("\033[2K\r\033[0;32m<3<3Kazandın<3<3\n");
	...
	else if (g->map[g->p_y + y][g->p_x + x] == 'N')
	{
		...
		ft_printf("\033[2K\r\033[0;33m>>>Duvarı Gormuyon Mu?<<<\n");
}
