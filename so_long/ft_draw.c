...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/21 15:23:17 by shopa             #+#    #+#             */
/*   Updated: 2022/04/25 15:07:05 by shopa            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_draw_item(struct s_elements *g)
{
	...
	g->m_p = mlx_init();
	g->p_xp = "xpm/player_animation/1.xpm";
	g->c_xp = "xpm/coin_animation/1.xpm";
	g->b_xp = "xpm/bg.xpm";
	g->w_xp = "xpm/wall.xpm";
	g->d_xp = "xpm/door.xpm";
	g->e_xp = "xpm/enemy.xpm";
